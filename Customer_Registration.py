...
class Register:
    ...
    def __init__(self, root):
        ...
        title = Label(frame1, text="CUSTOMER REGISTRATION", font=("Times new roman", 20, "bold"), bg="white", fg="green").place(x=50, y=30)
        ...
        # elif self.txt_emailid.get() != '^(\w|\.|\_|\-)+[@](\w|\_|\-|\.)+[.]\w{2,3}$':
            ...
            try:
                ...
                if row!=None:
                    ...
                    cur.execute("insert into customer (f_name,l_name,gender,email_id,ph_no,username,password) values(%s,%s,%s,%s,%s,%s,%s)",
                                (
                                    self.txt_fname.get(),
                                    self.txt_lname.get(),
                                    self.gender.get(),
